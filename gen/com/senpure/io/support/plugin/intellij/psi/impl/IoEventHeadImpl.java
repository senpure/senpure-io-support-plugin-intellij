...
public class IoEventHeadImpl extends ASTWrapperPsiElement implements IoEventHead {

  public IoEventHeadImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IoVisitor visitor) {
    visitor.visitEventHead(this);
  }
