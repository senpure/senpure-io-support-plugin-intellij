...
public class IoLuaNamespaceHeadImpl extends ASTWrapperPsiElement implements IoLuaNamespaceHead {

  public IoLuaNamespaceHeadImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IoVisitor visitor) {
    visitor.visitLuaNamespaceHead(this);
  }
