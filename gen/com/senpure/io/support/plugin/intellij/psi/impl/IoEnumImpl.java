...
public class IoEnumImpl extends ASTWrapperPsiElement implements IoEnum {

  public IoEnumImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<IoEnumField> getEnumFieldList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, IoEnumField.class);
  }

  @Override
  @NotNull
  public IoEnumHead getEnumHead() {
    return findNotNullChildByClass(IoEnumHead.class);
  }

  @Override
  @NotNull
  public IoEnumName getEnumName() {
    return findNotNullChildByClass(IoEnumName.class);
  }
