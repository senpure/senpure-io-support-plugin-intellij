...
public class IoMessageHeadImpl extends ASTWrapperPsiElement implements IoMessageHead {

  public IoMessageHeadImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IoVisitor visitor) {
    visitor.visitMessageHead(this);
  }
