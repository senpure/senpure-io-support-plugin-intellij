...
public class IoHeadImpl extends ASTWrapperPsiElement implements IoHead {

  public IoHeadImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<IoHeadContent> getHeadContentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, IoHeadContent.class);
  }
