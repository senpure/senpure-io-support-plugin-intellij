...
public class IoFieldIndexImpl extends ASTWrapperPsiElement implements IoFieldIndex {

  public IoFieldIndexImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IoVisitor visitor) {
    visitor.visitFieldIndex(this);
  }
