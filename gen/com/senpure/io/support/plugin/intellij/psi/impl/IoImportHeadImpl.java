...
public class IoImportHeadImpl extends ASTWrapperPsiElement implements IoImportHead {

  public IoImportHeadImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IoVisitor visitor) {
    visitor.visitImportHead(this);
  }
