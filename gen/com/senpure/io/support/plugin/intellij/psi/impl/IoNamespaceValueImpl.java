...
public class IoNamespaceValueImpl extends ASTWrapperPsiElement implements IoNamespaceValue {

  public IoNamespaceValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IoVisitor visitor) {
    visitor.visitNamespaceValue(this);
  }
