...
public class IoImportValueImpl extends ASTWrapperPsiElement implements IoImportValue {

  public IoImportValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IoVisitor visitor) {
    visitor.visitImportValue(this);
  }
