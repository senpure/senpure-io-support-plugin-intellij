...
public class IoFieldCommentImpl extends ASTWrapperPsiElement implements IoFieldComment {

  public IoFieldCommentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IoVisitor visitor) {
    visitor.visitFieldComment(this);
  }
