...
public class IoJsNamespaceValueImpl extends ASTWrapperPsiElement implements IoJsNamespaceValue {

  public IoJsNamespaceValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IoVisitor visitor) {
    visitor.visitJsNamespaceValue(this);
  }
